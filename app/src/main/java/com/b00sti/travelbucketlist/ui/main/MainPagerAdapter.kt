...
class MainPagerAdapter(fragmentManager: FragmentManager) : FragmentPagerAdapter(fragmentManager) {
    ...
    init {
        fragments.add(EmptyFragment.getInstance("Fragment 1"))
        fragments.add(EmptyFragment.getInstance("Fragment 2"))
        fragments.add(EmptyFragment.getInstance("Fragment 3"))
    }
